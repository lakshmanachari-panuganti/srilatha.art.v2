...
const QUICK_LINKS   = [{ href: '/shop', label: 'Shop' }, { href: '/custom-order', label: 'Custom Order' }, { href: '/about', label: 'About' }, { href: '/blog', label: 'Blog' }, { href: '/contact', label: 'Contact' }];
      ...
      <div className="container">
        <div className="footer-grid">
          ...
          <div>
            ...
            <div className="footer-brand-tagline">Where Art Meets Soul ✨</div>
            <p className="footer-brand-desc">
              Premium handmade Indian folk art from Chennai.
            ...
            <div style={{ marginTop: 'var(--sp-5)' }}>
              <p style={{ fontSize: '0.75rem', color: 'var(--text-muted)', marginBottom: 'var(--sp-2)', fontWeight: 600 }}>Get 10% off your first order:</p>
              <form
          ...
          <div>
            ...
            <div style={{ marginTop: 'var(--sp-6)', display: 'flex', flexDirection: 'column', gap: 'var(--sp-3)' }}>
              <a
                ...
                style={{ display: 'flex', alignItems: 'center', gap: 'var(--sp-2)', fontSize: '0.82rem', color: '#25D366' }}
              >
              ...
              <a href="mailto:hello@srilatha.art" style={{ display: 'flex', alignItems: 'center', gap: 'var(--sp-2)', fontSize: '0.82rem', color: 'var(--text-muted)' }}>
        ...
        <div className="footer-bottom">
          <p className="footer-bottom-text">
            © {currentYear} Srilatha Art · Handmade with ♥ in Chennai, India
          </p>
