        ...
        <div className="footer-grid">
          ...
          <div>
            ...
            <div style={{ marginTop: 'var(--sp-6)', display: 'flex', flexDirection: 'column', gap: 'var(--sp-3)' }}>
              ...
              <a href={`mailto:${CONTACT.email}`} style={{ display: 'flex', alignItems: 'center', gap: 'var(--sp-2)', fontSize: '0.82rem', color: 'var(--text-muted)' }}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
                {CONTACT.email}
              </a>
              <address style={{ fontStyle: 'normal', fontSize: '0.78rem', color: 'var(--text-muted)', lineHeight: 1.6 }}>
